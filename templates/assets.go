...
func assetsPipelineYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/pipeline.yml", size: 10945, mode: os.FileMode(420), modTime: time.Unix(1487959809, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
