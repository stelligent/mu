...
func assetsPipelineYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/pipeline.yml", size: 12430, mode: os.FileMode(420), modTime: time.Unix(1488953817, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
