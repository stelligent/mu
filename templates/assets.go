...
func assetsPipelineYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/pipeline.yml", size: 12210, mode: os.FileMode(420), modTime: time.Unix(1488948221, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
