...
func TestNewApp(t *testing.T) {
	...
	assert.Equal(6, len(app.Commands), "Commands len should match")
	...
	assert.Equal("database", app.Commands[4].Name, "Command[3].name should match")
	assert.Equal("validate", app.Commands[5].Name, "Command[3].name should match")
}
